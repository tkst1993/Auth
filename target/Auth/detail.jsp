...
<!--[if !IE]><!-->
<html lang="cn" data-ng-app="MetronicApp">
    <!--<![endif]-->
    <!-- BEGIN HEAD -->

    <head>
        <title data-ng-bind="'Spark Tools | ' + $state.current.data.pageTitle"></title>
        <meta charset="utf-8" />
        ...
        <!-- END THEME STYLES -->
        <link rel="shortcut icon" href="./view/drupal.png" /> </head>
    <!-- END HEAD -->
    <!-- BEGIN BODY -->
    ...
    <body ng-controller="AppController" class="page-header-fixed page-sidebar-closed-hide-logo page-on-load" ng-class="{'page-content-white': settings.layout.pageContentWhite,'page-container-bg-solid': settings.layout.pageBodySolid, 'page-sidebar-closed': settings.layout.pageSidebarClosed}">
        ...
        <!-- END PAGE SPINNER -->
        <!-- BEGIN HEADER -->
        <div data-ng-include="'./view/tpl/header.jsp'" data-ng-controller="HeaderController" class="page-header navbar navbar-fixed-top"> </div>
        <!-- END HEADER -->
        <div class="clearfix"> </div>
        <!-- BEGIN CONTAINER -->
        <div class="page-container">
            <!-- BEGIN SIDEBAR -->
            <div data-ng-include="'./view/tpl/sidebar.jsp'" data-ng-controller="SidebarController" class="page-sidebar-wrapper"> </div>
            <!-- END SIDEBAR -->
            <!-- BEGIN CONTENT -->
            <div class="page-content-wrapper">
                <div class="page-content">
                    <!-- BEGIN STYLE CUSTOMIZER(optional) -->
                    <div data-ng-include="'./view/tpl/theme-panel.jsp'" data-ng-controller="ThemePanelController" class="theme-panel hidden-xs hidden-sm"> </div>
        ...
        <!-- END CONTAINER -->
        <!-- BEGIN FOOTER -->
        <div data-ng-include="'./view/tpl/footer.jsp'" data-ng-controller="FooterController" class="page-footer"> </div>
        <!-- END FOOTER -->
    ...
    <![endif]-->
        ...
        <script src="./view/js/directives.js" type="text/javascript"></script>
        <script src="./view/js/controllers.js" type="text/javascript"></script>
